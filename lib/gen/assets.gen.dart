...
class $AssetsAnimationIconGen {
  ...
  /// File path: assets/animation_icon/Animation2.json
  String get animation2 => 'assets/animation_icon/Animation2.json';

  /// File path: assets/animation_icon/Animation3.json
  String get animation3 => 'assets/animation_icon/Animation3.json';

  /// File path: assets/animation_icon/Animation4.json
  String get animation4 => 'assets/animation_icon/Animation4.json';
  ...
  /// File path: assets/animation_icon/tree.json
  String get tree => 'assets/animation_icon/tree.json';
...
class $AssetsMusicGen {
  ...
  /// File path: assets/music/muaroi.mp3
  String get muaroi => 'assets/music/muaroi.mp3';

  /// File path: assets/music/suoichay.mp3
  String get suoichay => 'assets/music/suoichay.mp3';

  /// File path: assets/music/thienlyoi.mp3
  String get thienlyoi => 'assets/music/thienlyoi.mp3';

  /// List of all assets
  List<String> get values => [muaroi, suoichay, thienlyoi];
}
