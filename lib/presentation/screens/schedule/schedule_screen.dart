...
final event = Event(
    ...
    start: TimeOfDay.now(),status: false);
final event1 = Event(
    ...
    start: TimeOfDay.now(),status: true);
final listEvents = [
  event,
  event1,
  event,
                    ...
                    return ValueListenableBuilder<CalendarFormat>(
                      ...
                      builder: (context, value, _) {
                        return AnimatedCrossFade(
                          ...
                          firstChild: _buildTableCalendar(CalendarFormat.week),
                          secondChild: _buildTableCalendar(CalendarFormat.month),
